...
public class RemarkRouteListAdapter extends RecyclerView.Adapter<RemarkRouteListAdapter.ViewHolder> {
    public ArrayList<RouteListModel> mDataset;
    private Context mContext;

    public RemarkRouteListAdapter(Context mContext, ArrayList<RouteListModel> myDataset) {
        this.mContext = mContext;
        this.mDataset = myDataset;
    }

    @Override
    public RemarkRouteListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_route, null, false);
        RemarkRouteListAdapter.ViewHolder vh = new RemarkRouteListAdapter.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(final RemarkRouteListAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //((PlannerRouteListFragment) mContext)
